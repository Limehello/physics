...
public class PhysicsMass {
    ...
    public double convertToKG(PhysicsMass other) {
        return other.getMass() / 1000;
    }
    public double convertToMG(PhysicsMass other) {
        return other.getMass() * 1000;
    }
    public double convertToLB(PhysicsMass other) {
        return other.getMass() / 453.6;
    }
    public double convertToOZ(PhysicsMass other) {
        return other.getMass() / 28.3;
    }
    public double convertToMetricTon(PhysicsMass other) {
        return other.getMass() / 1000000;
    }
    public double convertToGR() {
